...
class TrialRow(BaseModel):
    ...
    phase: Literal["pilot", "main", "final", "baselines", "baselines_gridA", "grid_rq1_7b", "align_lam_sweep", "formatonly_fix", "basecheck", "rq1_generic", "loto_generic", "rq2_generic", "baselines_generic", "rank_generic", "extra_generic", "merge_sweep_generic", "mole_generic", "h1_codellama"]
    experiment_id: str
    base_model: str
