...
- [`2026-09-13_merge-backward-reverses-on-granite.md`](2026-09-13_merge-backward-reverses-on-granite.md) — **reverses on Granite** (DR −0.68): merging is not backward-safe; the cost is model-dependent.
...
- [`2026-09-14_gemma3-nan-cause-found.md`](2026-09-14_gemma3-nan-cause-found.md) — clip_grad_norm_ turns one bad gradient into an all-NaN model; skip the step instead.
- [`2026-09-14_merge-backward-all-eight.md`](2026-09-14_merge-backward-all-eight.md) — DARE-TIES positive backwards on 8/8, significant on 7; first fully comparable read.
...
- [`2026-09-21_seed-noise-floor.md`](2026-09-21_seed-noise-floor.md) — **APPLIED 2026-09-22**: the floor is now `tab:seednoise` in the paper and RQ3's router-vs-merge ordering on the held-out family is rescoped to *not below*. See [`../writeup/2026-09-22_a5-b7-b8-into-the-paper-and-the-noise-floor.md`](../writeup/2026-09-22_a5-b7-b8-into-the-paper-and-the-noise-floor.md).
