...
## Entries
- [`2026-09-10_cons-arms-ran-as-plain-sft.md`](2026-09-10_cons-arms-ran-as-plain-sft.md) — **the consistency arms were plain SFT.** Wrong entry point; `train_sft` silently ignores `objective:`. Caught by two cells sharing an exact correct-answer count, not by any guard. ~20 GPU-h. Would have read as R2 failing to replicate.
