...
- **H-llama31** (opened 09-04, gate read 09-05 NO-GO — untuned equals CodeLlama-7b on L0, 0.257 vs 0.257, and is weaker conditional on format): reduced probe only. CONFIRM (promote to full grid) if `tuned_L0(llama31-8b)` beats 0.430 outside the seed band. Jobs 377846-377850.
