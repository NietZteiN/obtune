...
\definecolor{custom-blue}{rgb}{0,0,1}
...
\newcommand{\up}[1]{\textcolor{green!55!black}{#1}}
\newcommand{\down}[1]{\textcolor{red!70!black}{#1}}
\newcommand{\bad}[1]{%
  \textcolor{red!70!black}{#1\textsuperscript{\ensuremath{\dagger}}}%
}
\usepackage{tikz}
...
% Preamble
%\usepackage[most]{tcolorbox}   % already loaded [skins] above; a second load is an option clash
% `\FloatBarrier` is used in sections/results.tex and was undefined, which is what stopped the
% delivered source from building. `takeaway` below was already defined and was never the problem.
\usepackage{placeins}
...
%\title{Building Blocks of Program Reasoning:}
% \title{Composing Specialists by Merging for Stacked Obfuscations}
\title{Building Blocks of Program Reasoning: Composing Obfuscation Specialists by Merging}
...
\input{sections/intro-3}
% \input{sections/rqs}
\input{sections/background-2}
\input{sections/merging}
