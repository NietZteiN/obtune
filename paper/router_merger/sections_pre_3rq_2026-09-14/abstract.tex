...
inference-time routing, weight-space merging, and training on a breadth of transforms, fail both --- merging outright, routing by matching breadth wherever the two are measured together.
