...
inference-time routing, weight-space merging, and training on a breadth of transforms, fall short: breadth fails both, routing matches breadth wherever the two are measured together, and merging composes less than breadth on seen stacks though it keeps that smaller gain under an unseen family.
