...
nineteen points. We ask what that number is made of, and we ask it in three regimes rather than one:
...
Across eight models and four lineages, the regimes disagree. On seen compositions every adaptation
works and the differences are two to four points. Outside them the ordering inverts. A single adapter
trained on all five transforms at once --- the obvious way to spend the data --- is below every
arm assembled from per-transform specialists on the unseen family, on all eight models, and below an
...
never significantly below it in any regime on any model --- at a cost of two to four forward points
