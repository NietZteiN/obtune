...
reverse direction. Obfuscation removes up to half of an untuned model's clean-code accuracy. Adapted models reading
obfuscated programs reach 110--195\,\% of that clean-code accuracy, above 100\,\% on 78 of 84
model\,$\times$\,condition-group cells and on an obfuscator family they never saw. On seen
compositions every adaptation achieves this and the choice between them is worth a few points. Outside them the ordering inverts. Training one adapter on everything --- the obvious use
