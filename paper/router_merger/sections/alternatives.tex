...
prompt~\cite{fewshot}, drawn from the training split of the same condition and held fixed across
items so the comparison is not confounded by example selection. It tests whether the \emph{task
format}, rather than the obfuscation, is what the untuned model is failing at.
