...
The learned router is worth about a point over a random routing policy
and nothing over breadth training; merging specialized models gains less
than broader training on stacks of seen transformations, though it keeps that
smaller gain when an unseen family enters; and broader training, although effective on stacks assembled
