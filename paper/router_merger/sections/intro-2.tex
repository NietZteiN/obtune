...
\textbf{2. Adaptation on obfuscated code exceeds clean-code accuracy, not merely recovers it.} Measured against the untuned model's accuracy on unobfuscated source, adapted models reading obfuscated programs reach 110--195\,\% of it, above 100\,\% on 78 of 84 model\,$\times$\,condition-group cells and on a held-out obfuscator family. The effect is specific to the trained direction and does not extend to the untrained one.
