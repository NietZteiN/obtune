...
| StarCoder2-15B | seen / unseen | −0.69 / **+1.15** | **−3.27** / **+1.70** | **−5.73** / +0.39 |

Merging gains less than breadth or anchoring on seen stacks and keeps its gain when the unseen family
enters — above breadth on 4/4 models there, above anchoring on Granite only. Rule a (merge ≤ control on seen
...
### 6.5c Routing on unseen-containing stacks (2026-09-13, H-F2-route REFUTED)
