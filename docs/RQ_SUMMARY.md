...
| **`cons_lam3 − mono_all` on X1** (RQ3′, `an_e3`) | **+4.59** [+3.16, +5.99] (3 seeds) | **+3.95** [+2.22, +5.84] | **+3.38** [+1.32, +5.51] | consistency removes breadth's unseen tax at every scale |
| **`cons_lam3 − tuned_L0` on X1** (the tax consistency pays) | −0.30 [−1.80, +1.32] | −0.33 [−2.06, +1.48] | +0.74 [−0.99, +2.47] | none, at any scale |
