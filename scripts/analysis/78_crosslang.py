...
ARMS = [("base","base"),("tuned_L0","clean"),("mono_all","breadth"),
        ("merge_dare_ties","merge"),("mole_router","router")]
GROUPS = [("L0", ["L0"]),
...
def _tex(out):
    ...
    cols = ["base", "clean", "breadth", "merge", "router"]
...
def main() -> int:
    ...
    for m in MODELS:
        ...
        cons = [("breadth - base", "mono_all", "base"),
                ...
                # In Python the router beats the merge on the unseen FAMILY on 7 of 8 models.
                # A new language is a different kind of unfamiliar surface; this asks whether
                # that advantage crosses it.
                ("router - merge", "mole_router", "merge_dare_ties"),
                ("router - breadth", "mole_router", "mono_all")]
        cr = {}
        for lab, a, b in cons:
