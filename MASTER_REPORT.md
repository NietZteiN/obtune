...
- [2. What exists — the inventory](#2-what-exists--the-inventory)
  ...
  - [2.2b Every system, every condition — the CodeLlama / Llama panel](#22b-every-system-every-condition--the-codellama--llama-panel)
...
| **`mean single`** | *(added 2026-09-08)* Mean accuracy over the five **single obfuscation transforms** — `L1b`, `L1r`, `L2`, `S1`, `S2`. `L0` is excluded because clean code is not a transform (it keeps its own column), and `S3`/`S4` are excluded because they are halves of `S2` that most rows never ran — including them would drop coverage from 144 rows to 104. **Blank whenever any of the five is missing**, rather than averaging over whatever is present, because a mean over a row-dependent column set is not comparable between rows. 144 of 169 rows qualify. |
| **`unseen (H1)`** | *(added 2026-09-08)* The row's **`H1`** value, repeated here so the three summary columns sit together and the seen/unseen/stacked comparison can be made across one row without hunting. It is a single column, not an average — `H1` is the only held-out condition in this table. 74 of 169 rows have it. |
| **`mean composed`** | *(added 2026-09-08)* Mean accuracy over the six **stacked composite** conditions (`C_*`), which are two transforms applied in sequence. Blank unless all six are present; 106 of 169 rows qualify. Kept separate from `mean single` because a composite is a different population, not a harder point on the same scale. |
...
| system | grid | settings | **‖ΔW‖** | **mean single** | **unseen (H1)** | **mean composed** | L0 | L1b | L1r | L2 | S1 | S2 | S3 | S4 | **H1** | C_L1r_S1 | C_S1_L1r | C_L1b_S1 | C_L2_S4 | C_L1r_S3 | C_S4_S3 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **Reference** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `base` | A | no adapter, no demos | — | **0.186** | **0.063** | **0.152** | 0.218 | 0.189 | 0.187 | 0.196 | 0.205 | 0.151 | 0.160 | 0.193 | 0.063 | 0.176 | 0.160 | 0.156 | 0.152 | 0.120 | 0.151 |
| `base` | B | no adapter, no demos | — | **0.225** | **0.113** | **0.225** | 0.290 | 0.233 | 0.233 | 0.210 | 0.262 | 0.188 | 0.182 | 0.222 | 0.113 | 0.267 | 0.247 | 0.320 | 0.176 | 0.159 | 0.182 |
| `tuned_L0` | A | r32 · s17 · L0 | 0.363 | **0.377** | **0.247** | **0.313** | 0.450 | 0.342 | 0.365 | 0.374 | 0.391 | 0.414 | 0.431 | 0.432 | 0.247 | 0.271 | 0.246 | 0.248 | 0.344 | 0.345 | 0.423 |
| `tuned_L0` | B | r32 · s17 · L0 | 0.363 | **0.450** | **0.400** |  | 0.494 | 0.369 | 0.460 | 0.500 | 0.434 | 0.489 | 0.483 | 0.455 | 0.400 | — | — | — | — | — | — |
| `tuned_L0_s17` | A | r32 · s17 · L0 | 0.363 | **0.378** | **0.247** | **0.313** | 0.447 | 0.344 | 0.367 | 0.375 | 0.390 | 0.415 | 0.431 | 0.431 | 0.247 | 0.271 | 0.245 | 0.247 | 0.343 | 0.346 | 0.424 |
| `tuned_L0_s42` | A | r32 · s42 · L0 | 0.365 | **0.377** | **0.247** | **0.318** | 0.447 | 0.337 | 0.373 | 0.369 | 0.387 | 0.421 | 0.446 | 0.429 | 0.247 | 0.281 | 0.256 | 0.255 | 0.349 | 0.340 | 0.428 |
| `ctl_r64` | A | r64 · s17 · L0 | 0.292 | **0.376** | **0.231** | **0.312** | 0.449 | 0.336 | 0.371 | 0.380 | 0.384 | 0.409 | 0.435 | 0.430 | 0.231 | 0.280 | 0.242 | 0.257 | 0.344 | 0.335 | 0.413 |
| **RQ1 specialists — Grid A, seeds 17 / 42** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `tuned_L1b_s17` | A | r32 · s17 · L1b | 0.369 | **0.383** | **0.250** | **0.324** | 0.438 | 0.384 | 0.381 | 0.385 | 0.357 | 0.409 | 0.435 | 0.433 | 0.250 | 0.275 | 0.250 | 0.285 | 0.362 | 0.353 | 0.418 |
| `tuned_L1b_s42` | A | r32 · s42 · L1b | 0.371 | **0.384** | **0.227** | **0.329** | 0.436 | 0.394 | 0.386 | 0.386 | 0.347 | 0.409 | 0.432 | 0.426 | 0.227 | 0.281 | 0.259 | 0.284 | 0.367 | 0.366 | 0.415 |
| `tuned_L1r_s17` | A | r32 · s17 · L1r | 0.301 | **0.391** | **0.247** | **0.331** | 0.453 | 0.355 | 0.396 | 0.394 | 0.383 | 0.427 | 0.440 | 0.445 | 0.247 | 0.294 | 0.263 | 0.267 | 0.362 | 0.376 | 0.425 |
| `tuned_L1r_s42` | A | r32 · s42 · L1r | 0.368 | **0.389** | **0.245** | **0.335** | 0.445 | 0.361 | 0.389 | 0.388 | 0.379 | 0.430 | 0.440 | 0.438 | 0.245 | 0.300 | 0.267 | 0.266 | 0.370 | 0.378 | 0.430 |
| `tuned_L2_s17` | A | r32 · s17 · L2 | 0.378 | **0.381** | **0.245** | **0.322** | 0.440 | 0.349 | 0.380 | 0.377 | 0.376 | 0.421 | 0.432 | 0.428 | 0.245 | 0.283 | 0.257 | 0.250 | 0.355 | 0.361 | 0.424 |
| `tuned_L2_s42` | A | r32 · s42 · L2 | 0.369 | **0.382** | **0.242** | **0.326** | 0.447 | 0.353 | 0.379 | 0.386 | 0.375 | 0.417 | 0.436 | 0.436 | 0.242 | 0.288 | 0.257 | 0.260 | 0.369 | 0.359 | 0.422 |
| `tuned_S1_s17` | A | r32 · s17 · S1 | 0.331 | **0.382** | **0.254** | **0.334** | 0.435 | 0.319 | 0.368 | 0.374 | 0.424 | 0.425 | 0.425 | 0.428 | 0.254 | 0.310 | 0.299 | 0.295 | 0.352 | 0.334 | 0.413 |
| `tuned_S1_s42` | A | r32 · s42 · S1 | 0.320 | **0.385** | **0.252** | **0.338** | 0.445 | 0.326 | 0.363 | 0.378 | 0.430 | 0.427 | 0.425 | 0.435 | 0.252 | 0.307 | 0.313 | 0.277 | 0.359 | 0.343 | 0.431 |
| `tuned_S2_s17` | A | r32 · s17 · S2 | 0.380 | **0.394** | **0.280** | **0.343** | 0.456 | 0.333 | 0.374 | 0.378 | 0.434 | 0.453 | 0.454 | 0.454 | 0.280 | 0.308 | 0.275 | 0.278 | 0.376 | 0.362 | 0.458 |
| `tuned_S2_s42` | A | r32 · s42 · S2 | 0.380 | **0.392** | **0.275** | **0.342** | 0.446 | 0.338 | 0.372 | 0.381 | 0.424 | 0.447 | 0.450 | 0.452 | 0.275 | 0.303 | 0.270 | 0.275 | 0.381 | 0.370 | 0.451 |
| **RQ1 specialists — Grid B** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `tuned_L1b` | B | r32 · s17 · L1b | 0.369 | **0.466** | **0.383** | **0.443** | 0.477 | 0.460 | 0.511 | 0.483 | 0.434 | 0.443 | 0.483 | 0.466 | 0.383 | 0.400 | 0.427 | 0.433 | 0.483 | 0.449 | 0.466 |
| `tuned_L1r` | B | r32 · s17 · L1r | 0.301 | **0.437** |  | **0.393** | 0.477 | 0.386 | 0.460 | 0.477 | 0.421 | 0.443 | 0.443 | 0.466 | — | 0.347 | 0.360 | 0.360 | 0.443 | 0.420 | 0.426 |
| `tuned_L2` | B | r32 · s17 · L2 | 0.378 | **0.471** |  | **0.428** | 0.466 | 0.477 | 0.489 | 0.511 | 0.434 | 0.443 | 0.455 | 0.466 | — | 0.407 | 0.407 | 0.360 | 0.466 | 0.455 | 0.472 |
| `tuned_S1` | B | r32 · s17 · S1 | 0.331 | **0.407** |  | **0.378** | 0.415 | 0.330 | 0.438 | 0.455 | 0.441 | 0.369 | 0.415 | 0.409 | — | 0.340 | 0.413 | 0.327 | 0.415 | 0.347 | 0.426 |
| `tuned_S2` | B | r32 · s17 · S2 | 0.380 | **0.469** |  | **0.419** | 0.477 | 0.415 | 0.483 | 0.506 | 0.469 | 0.472 | 0.483 | 0.506 | — | 0.360 | 0.393 | 0.333 | 0.489 | 0.449 | 0.489 |
| `tuned_S3` | B | r32 · s17 · S3 | 0.308 | **0.444** |  | **0.397** | 0.466 | 0.381 | 0.477 | 0.449 | 0.448 | 0.466 | 0.455 | 0.460 | — | 0.347 | 0.393 | 0.320 | 0.455 | 0.409 | 0.460 |
| `tuned_S4` | B | r32 · s17 · S4 | 0.376 | **0.464** |  | **0.421** | 0.483 | 0.426 | 0.500 | 0.466 | 0.455 | 0.472 | 0.460 | 0.500 | — | 0.407 | 0.367 | 0.333 | 0.489 | 0.449 | 0.483 |
| **Shot count — ICL, and ICL applied to an adapter (§11)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `icl_k1` | B | 0 train · k=1 demos | — | **0.273** | **0.226** | **0.245** | 0.341 | 0.244 | 0.284 | 0.290 | 0.297 | 0.250 | 0.301 | 0.273 | 0.226 | 0.247 | 0.260 | 0.247 | 0.239 | 0.239 | 0.239 |
| `icl_k2` | B | 0 train · k=2 demos | — | **0.299** | **0.287** | **0.284** | 0.364 | 0.267 | 0.301 | 0.352 | 0.283 | 0.290 | 0.324 | 0.318 | 0.287 | 0.293 | 0.280 | 0.260 | 0.290 | 0.290 | 0.290 |
| `icl_k4` | B | 0 train · k=4 demos | — | **0.303** | **0.287** | **0.298** | 0.375 | 0.273 | 0.301 | 0.330 | 0.310 | 0.301 | 0.347 | 0.330 | 0.287 | 0.273 | 0.300 | 0.280 | 0.312 | 0.312 | 0.312 |
| `tuned_L0_k0` | B | r32 · s17 · L0 · k=0 demos | 0.363 | **0.451** | **0.339** | **0.415** | 0.500 | 0.398 | 0.494 | 0.460 | 0.448 | 0.455 | 0.477 | 0.449 | 0.339 | 0.400 | 0.400 | 0.360 | 0.432 | 0.438 | 0.460 |
| `tuned_L0_k1` | B | r32 · s17 · L0 · k=1 demos | 0.363 | **0.427** | **0.339** | **0.385** | 0.472 | 0.392 | 0.426 | 0.477 | 0.400 | 0.438 | 0.443 | 0.432 | 0.339 | 0.360 | 0.413 | 0.273 | 0.415 | 0.386 | 0.460 |
| `tuned_L0_k2` | B | r32 · s17 · L0 · k=2 demos | 0.363 | **0.418** | **0.287** | **0.372** | 0.489 | 0.375 | 0.438 | 0.460 | 0.407 | 0.409 | 0.466 | 0.449 | 0.287 | 0.347 | 0.360 | 0.313 | 0.381 | 0.392 | 0.438 |
| `tuned_L0_k4` | B | r32 · s17 · L0 · k=4 demos | 0.363 | **0.416** | **0.339** | **0.348** | 0.455 | 0.358 | 0.415 | 0.460 | 0.414 | 0.432 | 0.466 | 0.455 | 0.339 | 0.293 | 0.313 | 0.267 | 0.392 | 0.386 | 0.438 |
| **Zero-training baselines — prompting and symbolic normalization (§12.2, §16)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `oracle_prompt` | B | 0 train · told the transform · 0 demos | — | **0.220** | **0.087** |  | 0.273 | 0.250 | 0.205 | 0.170 | 0.234 | 0.239 | — | — | 0.087 | — | — | — | — | — | — |
| `oracle_prompt_1shot` | A | 0 train · told the transform · 1 clean demo | — | **0.222** | **0.157** |  | 0.277 | 0.201 | 0.213 | 0.233 | 0.216 | 0.248 | — | — | 0.157 | — | — | — | — | — | — |
| `oracle_prompt_1shot` | B | 0 train · told the transform · 1 clean demo | — | **0.269** | **0.209** |  | 0.398 | 0.261 | 0.256 | 0.290 | 0.255 | 0.284 | — | — | 0.209 | — | — | — | — | — | — |
| `icl_k1_clean` | A | 0 train · k=1 demos · clean | — | **0.232** | **0.152** |  | 0.272 | 0.223 | 0.232 | 0.243 | 0.233 | 0.227 | — | — | 0.152 | — | — | — | — | — | — |
| `icl_k1_clean` | B | 0 train · k=1 demos · clean | — | **0.265** | **0.235** | **0.258** | 0.341 | 0.244 | 0.256 | 0.312 | 0.241 | 0.273 | 0.290 | 0.284 | 0.235 | 0.247 | 0.267 | 0.227 | 0.278 | 0.256 | 0.273 |
| `icl_k1_cross` | A | 0 train · k=1 demos · cross | — | **0.238** | **0.145** |  | 0.284 | 0.226 | 0.228 | 0.247 | 0.251 | 0.239 | — | — | 0.145 | — | — | — | — | — | — |
| `icl_k1_cross` | B | 0 train · k=1 demos · cross | — | **0.288** | **0.217** | **0.252** | 0.352 | 0.233 | 0.284 | 0.341 | 0.297 | 0.284 | 0.284 | 0.295 | 0.217 | 0.240 | 0.240 | 0.253 | 0.278 | 0.233 | 0.267 |
| `icl_k4_cross` | A | 0 train · k=4 demos · cross | — | **0.274** | **0.182** |  | 0.331 | 0.264 | 0.273 | 0.272 | 0.277 | 0.285 | — | — | 0.182 | — | — | — | — | — | — |
| `icl_k1_matched_struct` | B | 0 train · k=1 demos · matched struct | — | **0.257** | **0.252** | **0.247** | 0.312 | 0.239 | 0.261 | 0.273 | 0.262 | 0.250 | 0.278 | 0.261 | 0.252 | 0.267 | 0.247 | 0.253 | 0.250 | 0.227 | 0.239 |
| `norm_alpha` | B | 0 train · symbolic `alpha` pass | — | **0.210** | **0.052** | **0.193** | 0.222 | 0.233 | 0.250 | 0.210 | 0.193 | 0.165 | 0.148 | 0.193 | 0.052 | 0.253 | 0.227 | 0.267 | 0.159 | 0.148 | 0.102 |
| `norm_reformat` | B | 0 train · symbolic `reformat` pass | — | **0.223** | **0.113** | **0.221** | 0.284 | 0.227 | 0.216 | 0.210 | 0.269 | 0.193 | 0.193 | 0.222 | 0.113 | 0.253 | 0.240 | 0.313 | 0.188 | 0.153 | 0.176 |
| `norm_full` | A | 0 train · symbolic `full` pass | — | **0.188** | **0.099** |  | 0.212 | 0.189 | 0.195 | 0.198 | 0.178 | 0.180 | — | — | 0.099 | — | — | — | — | — | — |
| `norm_full` | B | 0 train · symbolic `full` pass | — | **0.221** | **0.139** | **0.217** | 0.227 | 0.244 | 0.244 | 0.210 | 0.186 | 0.222 | 0.227 | 0.188 | 0.139 | 0.247 | 0.227 | 0.253 | 0.148 | 0.244 | 0.182 |
| `norm_structural` | A | 0 train · symbolic `structural` pass | — | **0.195** | **0.129** |  | 0.220 | 0.188 | 0.189 | 0.197 | 0.200 | 0.199 | — | — | 0.129 | — | — | — | — | — | — |
| `norm_structural` | B | 0 train · symbolic `structural` pass | — |  |  | **0.240** | — | — | — | — | — | — | — | — | — | 0.260 | 0.240 | 0.313 | 0.182 | 0.227 | 0.216 |
...
| `mono_all` | A | r32 · s17 · all 6 | 0.744 | **0.387** | **0.229** | **0.356** | 0.416 | 0.381 | 0.367 | 0.379 | 0.392 | 0.415 | 0.416 | 0.415 | 0.229 | 0.334 | 0.326 | 0.322 | 0.373 | 0.368 | 0.413 |
| `mono_r64` | A | r64 · s17 · all 6 | 0.684 | **0.396** | **0.239** | **0.366** | 0.422 | 0.387 | 0.378 | 0.390 | 0.399 | 0.428 | 0.435 | 0.420 | 0.239 | 0.335 | 0.336 | 0.336 | 0.387 | 0.376 | 0.424 |
| `mono_r128` | A | r128 · s17 · all 6 | 0.889 | **0.395** | **0.214** | **0.373** | 0.430 | 0.387 | 0.383 | 0.387 | 0.397 | 0.419 | 0.427 | 0.422 | 0.214 | 0.342 | 0.340 | 0.345 | 0.392 | 0.389 | 0.428 |
| `mono_r192` | A | r192 · s17 · all 6 | 1.063 | **0.380** | **0.205** | **0.361** | 0.414 | 0.373 | 0.372 | 0.366 | 0.377 | 0.410 | 0.414 | 0.408 | 0.205 | 0.331 | 0.338 | 0.340 | 0.370 | 0.377 | 0.412 |
| **Leave-one-transform-out — honest unseen-transform folds (§12.10)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `loto_holdL0` | A | r32 · s17 · 5 of 6, **holding out L0** | 0.682 | **0.390** |  |  | 0.417 | 0.384 | 0.374 | 0.384 | 0.391 | 0.419 | — | — | — | — | — | — | — | — | — |
| `loto_holdL1b` | A | r32 · s17 · 5 of 6, **holding out L1b** | 0.677 | **0.389** |  |  | 0.429 | 0.365 | 0.375 | 0.385 | 0.391 | 0.430 | — | — | — | — | — | — | — | — | — |
| `loto_holdL1r` | A | r32 · s17 · 5 of 6, **holding out L1r** | 0.678 | **0.383** |  |  | 0.411 | 0.376 | 0.366 | 0.371 | 0.386 | 0.417 | — | — | — | — | — | — | — | — | — |
| `loto_holdL2` | A | r32 · s17 · 5 of 6, **holding out L2** | 0.802 | **0.385** |  |  | 0.413 | 0.376 | 0.375 | 0.367 | 0.391 | 0.415 | — | — | — | — | — | — | — | — | — |
| `loto_holdS1` | A | r32 · s17 · 5 of 6, **holding out S1** | 0.805 | **0.387** |  |  | 0.419 | 0.379 | 0.379 | 0.387 | 0.373 | 0.417 | — | — | — | — | — | — | — | — | — |
| `loto_holdS2` | A | r32 · s17 · 5 of 6, **holding out S2** | 0.684 | **0.385** |  |  | 0.422 | 0.381 | 0.375 | 0.381 | 0.393 | 0.393 | — | — | — | — | — | — | — | — | — |
| **RQ2 — routing and the six-specialist merges (§5.2)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `router` | B | 6 experts · classifier dispatch | — | **0.468** |  |  | 0.500 | 0.460 | 0.466 | 0.506 | 0.434 | 0.472 | — | — | — | — | — | — | — | — | — |
| `merge_ties` | A | 6 experts · TIES · d0.5 | 0.069 |  | **0.195** |  | — | — | — | — | — | — | — | — | 0.195 | — | — | — | — | — | — |
| `merge_ties` | B | 6 experts · TIES · d0.5 | 0.069 | **0.351** | **0.287** | **0.360** | 0.415 | 0.318 | 0.341 | 0.386 | 0.386 | 0.324 | 0.364 | 0.375 | 0.287 | 0.400 | 0.393 | 0.320 | 0.347 | 0.330 | 0.369 |
| `merge_dare_ties` | A | 6 experts · DARE-TIES · d0.5 | 0.226 |  | **0.239** |  | — | — | — | — | — | — | — | — | 0.239 | — | — | — | — | — | — |
| `merge_dare_ties` | B | 6 experts · DARE-TIES · d0.5 | 0.226 | **0.440** | **0.348** | **0.431** | 0.494 | 0.398 | 0.420 | 0.500 | 0.441 | 0.443 | 0.466 | 0.455 | 0.348 | 0.400 | 0.440 | 0.407 | 0.443 | 0.432 | 0.466 |
| `merge_ties_s42` | B | 6 experts · TIES · d0.5 · s42 bank | 0.070 | **0.351** | **0.278** |  | 0.415 | 0.324 | 0.330 | 0.392 | 0.379 | 0.330 | — | — | 0.278 | — | — | — | — | — | — |
| `merge_dare_ties_s42` | A | 6 experts · DARE-TIES · d0.5 · s42 bank | 0.231 |  | **0.249** |  | — | — | — | — | — | — | — | — | 0.249 | — | — | — | — | — | — |
| `merge_dare_ties_s42` | B | 6 experts · DARE-TIES · d0.5 · s42 bank | 0.231 | **0.446** | **0.383** |  | 0.506 | 0.403 | 0.438 | 0.489 | 0.434 | 0.466 | — | — | 0.383 | — | — | — | — | — | — |
| `merge_dare_linear` | B | 6 experts · DARE-linear · d0.5 — **defect** | 2.024 | **0.040** | **0.061** | **0.054** | 0.040 | 0.040 | 0.028 | 0.023 | 0.048 | 0.062 | 0.040 | 0.080 | 0.061 | 0.073 | 0.027 | 0.053 | 0.028 | 0.080 | 0.062 |
| `dl_rescaled` | B | 6 experts · DARE-linear **rescaled** (repair) | 0.282 | **0.452** |  | **0.443** | 0.472 | 0.398 | 0.449 | 0.511 | 0.441 | 0.460 | 0.460 | 0.466 | — | 0.420 | 0.460 | 0.420 | 0.460 | 0.426 | 0.472 |
| **RQ2 merge controls (§12.10, §12.12)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `l0merge_ties` | A | **3× clean-code adapters** s17/42/101 · TIES · d0.5 | 0.197 |  | **0.213** |  | — | — | — | — | — | — | — | — | 0.213 | — | — | — | — | — | — |
| `l0merge_ties` | B | **3× clean-code adapters** s17/42/101 · TIES · d0.5 | 0.197 | **0.389** | **0.304** |  | 0.466 | 0.347 | 0.375 | 0.438 | 0.400 | 0.386 | — | — | 0.304 | — | — | — | — | — | — |
| `l0merge_dare_ties` | A | **3× clean-code adapters** s17/42/101 · DARE-TIES · d0.5 | 0.457 |  | **0.214** |  | — | — | — | — | — | — | — | — | 0.214 | — | — | — | — | — | — |
| `l0merge_dare_ties` | B | **3× clean-code adapters** s17/42/101 · DARE-TIES · d0.5 | 0.457 | **0.407** | **0.339** |  | 0.466 | 0.352 | 0.409 | 0.460 | 0.407 | 0.409 | — | — | 0.339 | — | — | — | — | — | — |
| `crossseed_ties` | B | 6 experts, **each a different seed** · TIES · d0.5 | 0.089 | **0.346** | **0.287** |  | 0.415 | 0.330 | 0.324 | 0.381 | 0.379 | 0.318 | — | — | 0.287 | — | — | — | — | — | — |
| `crossseed_dare_ties` | B | 6 experts, **each a different seed** · DARE-TIES · d0.5 | 0.245 | **0.405** | **0.313** |  | 0.455 | 0.369 | 0.409 | 0.449 | 0.400 | 0.398 | — | — | 0.313 | — | — | — | — | — | — |
| **RQ2 merge density sweep and the residual-preserving merge (§12.12)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `sweep_ties_d0p3` | B | 6 experts · TIES · d0.3 — density sweep | 0.066 | **0.344** |  |  | 0.415 | 0.312 | 0.341 | 0.369 | 0.366 | 0.330 | — | — | — | — | — | — | — | — | — |
| `sweep_ties_d0p5` | B | 6 experts · TIES · d0.5 — density sweep | 0.069 | **0.349** |  |  | 0.409 | 0.324 | 0.341 | 0.381 | 0.386 | 0.312 | — | — | — | — | — | — | — | — | — |
| `sweep_ties_d0p7` | B | 6 experts · TIES · d0.7 — density sweep | 0.064 | **0.352** |  |  | 0.415 | 0.312 | 0.341 | 0.398 | 0.393 | 0.318 | — | — | — | — | — | — | — | — | — |
| `sweep_dare_ties_d0p3` | B | 6 experts · DARE-TIES · d0.3 — density sweep | 0.566 | **0.468** | **0.322** |  | 0.483 | 0.426 | 0.494 | 0.489 | 0.441 | 0.489 | — | — | 0.322 | — | — | — | — | — | — |
| `sweep_dare_ties_d0p5` | B | 6 experts · DARE-TIES · d0.5 — density sweep | 0.226 | **0.440** |  |  | 0.483 | 0.381 | 0.420 | 0.489 | 0.455 | 0.455 | — | — | — | — | — | — | — | — | — |
| `sweep_dare_ties_d0p7` | B | 6 experts · DARE-TIES · d0.7 — density sweep | 0.115 | **0.394** |  |  | 0.460 | 0.312 | 0.392 | 0.443 | 0.421 | 0.403 | — | — | — | — | — | — | — | — | — |
| `uniform_n8_s17_d0p5` | A | 8 experts · uniform weights · d0.5 | 0.168 |  | **0.231** |  | — | — | — | — | — | — | — | — | 0.231 | — | — | — | — | — | — |
| `uniform_n8_s17_d0p5` | B | 8 experts · uniform weights · d0.5 | 0.168 |  | **0.357** |  | — | — | — | — | — | — | — | — | 0.357 | — | — | — | — | — | — |
| `residual_ties_d0p3` | B | 6 experts · **residual-preserving** · TIES · d0.3 | 0.081 | **0.348** |  |  | 0.409 | 0.324 | 0.341 | 0.364 | 0.372 | 0.341 | — | — | — | — | — | — | — | — | — |
| `residual_ties_d0p5` | B | 6 experts · **residual-preserving** · TIES · d0.5 | 0.082 | **0.359** | **0.296** |  | 0.409 | 0.324 | 0.347 | 0.386 | 0.386 | 0.352 | — | — | 0.296 | — | — | — | — | — | — |
| `residual_dare_ties_d0p3` | B | 6 experts · **residual-preserving** · DARE-TIES · d0.3 | 0.721 | **0.419** |  |  | 0.443 | 0.364 | 0.455 | 0.466 | 0.379 | 0.432 | — | — | — | — | — | — | — | — | — |
| `residual_dare_ties_d0p5` | B | 6 experts · **residual-preserving** · DARE-TIES · d0.5 | 0.267 | **0.455** | **0.417** |  | 0.472 | 0.392 | 0.460 | 0.500 | 0.448 | 0.477 | — | — | 0.417 | — | — | — | — | — | — |
| `residual_n6_s17_d0p5` | A | 6 experts · **residual-preserving** · s17 · TIES · d0.5 | 0.362 |  | **0.259** |  | — | — | — | — | — | — | — | — | 0.259 | — | — | — | — | — | — |
| `residual_n6_s17_d0p5` | B | 6 experts · **residual-preserving** · s17 · TIES · d0.5 | 0.362 |  | **0.374** |  | — | — | — | — | — | — | — | — | 0.374 | — | — | — | — | — | — |
| `residual_n6_s42_d0p5` | A | 6 experts · **residual-preserving** · s42 · TIES · d0.5 | 0.359 |  | **0.256** |  | — | — | — | — | — | — | — | — | 0.256 | — | — | — | — | — | — |
| `residual_n6_s42_d0p5` | B | 6 experts · **residual-preserving** · s42 · TIES · d0.5 | 0.359 |  | **0.417** |  | — | — | — | — | — | — | — | — | 0.417 | — | — | — | — | — | — |
| `residual_n8_s17_d0p5` | A | 8 experts · **residual-preserving** · s17 · TIES · d0.5 | 0.168 |  | **0.253** |  | — | — | — | — | — | — | — | — | 0.253 | — | — | — | — | — | — |
| **RQ2 attempted repairs — all null (§12.11)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `s2fam` | A | r32 · s17 · S2+S3+S4 · 14,037 rows | 0.633 | **0.381** | **0.266** |  | 0.444 | 0.320 | 0.366 | 0.368 | 0.414 | 0.438 | — | — | 0.266 | — | — | — | — | — | — |
| `composite_trained` | A | r32 · s17 · 6 stacked C_* · 22,152 rows | 0.804 | **0.382** | **0.194** |  | 0.398 | 0.379 | 0.378 | 0.373 | 0.383 | 0.397 | — | — | 0.194 | — | — | — | — | — | — |
| `composite_ablation` | A | r32 · s17 · same 6 mechanisms **unstacked** | 0.682 | **0.393** | **0.237** |  | 0.423 | 0.386 | 0.377 | 0.379 | 0.395 | 0.428 | — | — | 0.237 | — | — | — | — | — | — |
| **RouterLoRA ladder, including the balanced gate (§5.4, §12.8–§12.10)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `mole_uniform` | B | 8 experts · gate frozen uniform | — | **0.463** | **0.330** | **0.422** | 0.466 | 0.392 | 0.506 | 0.500 | 0.441 | 0.477 | 0.449 | 0.466 | 0.330 | 0.367 | 0.413 | 0.393 | 0.466 | 0.443 | 0.449 |
| `mole_random` | B | 8 experts · gate frozen at random init | — | **0.463** | **0.330** | **0.415** | 0.466 | 0.386 | 0.500 | 0.500 | 0.448 | 0.483 | 0.449 | 0.472 | 0.330 | 0.360 | 0.407 | 0.380 | 0.449 | 0.443 | 0.449 |
| `mole_router` | B | 8 experts · trained gate | — | **0.496** | **0.339** | **0.454** | 0.494 | 0.477 | 0.511 | 0.523 | 0.476 | 0.494 | 0.443 | 0.489 | 0.339 | 0.407 | 0.420 | 0.420 | 0.540 | 0.460 | 0.477 |
| `mole_hardrouter` | B | 8 experts · trained gate, argmax one-hot | — | **0.493** | **0.322** | **0.460** | 0.489 | 0.477 | 0.517 | 0.517 | 0.469 | 0.483 | 0.438 | 0.494 | 0.322 | 0.413 | 0.420 | 0.447 | 0.523 | 0.477 | 0.477 |
| `mole_router_bal` | B | 8 experts · trained gate **+ load balancing** | — |  |  | **0.457** | — | — | 0.517 | — | 0.483 | — | — | — | — | 0.413 | 0.413 | 0.427 | 0.528 | 0.466 | 0.494 |
| `mole_hardrouter_bal` | B | 8 experts · balanced gate, argmax one-hot | — |  |  | **0.460** | — | — | 0.523 | — | 0.469 | — | — | — | — | 0.407 | 0.420 | 0.447 | 0.528 | 0.472 | 0.489 |
| **Uniform-epoch merges, 8-expert bank (§5.3)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `ties_e1` | B | 8 experts · TIES · @ e1 | 0.058 | **0.349** |  |  | 0.392 | 0.324 | 0.341 | 0.381 | 0.379 | 0.318 | — | — | — | — | — | — | — | — | — |
| `ties_e2` | B | 8 experts · TIES · @ e2 | 0.070 | **0.353** |  |  | 0.415 | 0.324 | 0.341 | 0.398 | 0.386 | 0.318 | — | — | — | — | — | — | — | — | — |
| `ties_e3` | B | 8 experts · TIES · @ e3 | 0.071 | **0.347** |  |  | 0.415 | 0.324 | 0.341 | 0.381 | 0.379 | 0.312 | — | — | — | — | — | — | — | — | — |
| `ties_e6` | B | 8 experts · TIES · @ e6 | — |  |  |  | — | 0.369 | — | — | 0.400 | 0.392 | — | — | — | — | — | — | — | — | — |
| `ties_e9` | B | 8 experts · TIES · @ e9 | — |  |  |  | — | 0.358 | — | — | 0.428 | 0.403 | — | — | — | — | — | — | — | — | — |
| `dare_ties_e1` | B | 8 experts · DARE-TIES · @ e1 | 0.190 | **0.433** |  |  | 0.466 | 0.386 | 0.426 | 0.460 | 0.434 | 0.460 | — | — | — | — | — | — | — | — | — |
| `dare_ties_e2` | B | 8 experts · DARE-TIES · @ e2 | 0.230 | **0.437** |  |  | 0.494 | 0.381 | 0.426 | 0.477 | 0.434 | 0.466 | — | — | — | — | — | — | — | — | — |
| `dare_ties_e3` | B | 8 experts · DARE-TIES · @ e3 | 0.236 | **0.452** |  |  | 0.477 | 0.403 | 0.449 | 0.500 | 0.448 | 0.460 | — | — | — | — | — | — | — | — | — |
| `dare_ties_e6` | B | 8 experts · DARE-TIES · @ e6 | — |  |  |  | — | 0.420 | — | — | 0.441 | 0.489 | — | — | — | — | — | — | — | — | — |
| `dare_ties_e9` | B | 8 experts · DARE-TIES · @ e9 | — |  |  |  | — | 0.443 | — | — | 0.441 | 0.483 | — | — | — | — | — | — | — | — | — |
| `overtrain_full_ties_e1` | B | 8-expert bank · TIES · uniform @ e1 | 0.056 | **0.345** |  | **0.345** | 0.392 | 0.307 | 0.335 | 0.386 | 0.366 | 0.330 | 0.358 | 0.364 | — | 0.380 | 0.387 | 0.307 | 0.318 | 0.324 | 0.352 |
| `overtrain_full_ties_e3` | B | 8-expert bank · TIES · uniform @ e3 | 0.101 | **0.351** |  | **0.355** | 0.403 | 0.318 | 0.341 | 0.398 | 0.379 | 0.318 | 0.364 | 0.369 | — | 0.387 | 0.393 | 0.313 | 0.341 | 0.330 | 0.364 |
| `overtrain_full_ties_e6` | B | 8-expert bank · TIES · uniform @ e6 | 0.119 | **0.350** |  | **0.366** | 0.409 | 0.312 | 0.341 | 0.392 | 0.359 | 0.347 | 0.364 | 0.375 | — | 0.387 | 0.407 | 0.333 | 0.364 | 0.341 | 0.364 |
| `overtrain_full_ties_e9` | B | 8-expert bank · TIES · uniform @ e9 | 0.121 | **0.359** |  | **0.367** | 0.415 | 0.307 | 0.347 | 0.398 | 0.393 | 0.352 | 0.369 | 0.381 | — | 0.393 | 0.407 | 0.340 | 0.352 | 0.335 | 0.375 |
| `overtrain_full_dare_ties_e1` | B | 8-expert bank · DARE-TIES · uniform @ e1 | 0.186 | **0.428** |  | **0.419** | 0.455 | 0.369 | 0.432 | 0.455 | 0.428 | 0.455 | 0.438 | 0.477 | — | 0.393 | 0.440 | 0.387 | 0.455 | 0.398 | 0.443 |
| `overtrain_full_dare_ties_e3` | B | 8-expert bank · DARE-TIES · uniform @ e3 | 0.326 | **0.442** |  | **0.425** | 0.494 | 0.398 | 0.443 | 0.472 | 0.455 | 0.443 | 0.489 | 0.466 | — | 0.380 | 0.447 | 0.380 | 0.460 | 0.426 | 0.455 |
| `overtrain_full_dare_ties_e6` | B | 8-expert bank · DARE-TIES · uniform @ e6 | 0.383 | **0.457** |  | **0.429** | 0.494 | 0.420 | 0.455 | 0.494 | 0.476 | 0.438 | 0.460 | 0.472 | — | 0.427 | 0.453 | 0.393 | 0.438 | 0.426 | 0.438 |
| `overtrain_full_dare_ties_e9` | B | 8-expert bank · DARE-TIES · uniform @ e9 | 0.387 | **0.460** |  | **0.435** | 0.483 | 0.443 | 0.438 | 0.477 | 0.476 | 0.466 | 0.466 | 0.460 | — | 0.427 | 0.453 | 0.413 | 0.438 | 0.432 | 0.449 |
| **3-expert overtrain sweep (§5.3)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `overtrain_sweep_ties_e1` | B | 3-expert probe · TIES · uniform @ e1 | 0.107 | **0.384** |  | **0.385** | 0.409 | 0.352 | 0.375 | 0.403 | 0.400 | 0.392 | 0.392 | 0.426 | — | 0.380 | 0.400 | 0.360 | 0.426 | 0.341 | 0.403 |
| `overtrain_sweep_ties_e3` | B | 3-expert probe · TIES · uniform @ e3 | 0.191 | **0.411** |  | **0.404** | 0.455 | 0.364 | 0.420 | 0.438 | 0.414 | 0.420 | 0.415 | 0.443 | — | 0.380 | 0.400 | 0.360 | 0.443 | 0.415 | 0.426 |
| `overtrain_sweep_ties_e6` | B | 3-expert probe · TIES · uniform @ e6 | 0.226 | **0.405** |  | **0.394** | 0.449 | 0.364 | 0.415 | 0.443 | 0.393 | 0.409 | 0.438 | 0.443 | — | 0.373 | 0.393 | 0.373 | 0.420 | 0.392 | 0.415 |
| `overtrain_sweep_ties_e9` | B | 3-expert probe · TIES · uniform @ e9 | 0.228 | **0.414** |  | **0.403** | 0.449 | 0.364 | 0.409 | 0.460 | 0.428 | 0.409 | 0.432 | 0.438 | — | 0.373 | 0.393 | 0.393 | 0.438 | 0.386 | 0.432 |
| `overtrain_sweep_dare_ties_e1` | B | 3-expert probe · DARE-TIES · uniform @ e1 | 0.331 | **0.430** |  | **0.411** | 0.477 | 0.375 | 0.438 | 0.438 | 0.441 | 0.460 | 0.443 | 0.466 | — | 0.353 | 0.407 | 0.367 | 0.443 | 0.432 | 0.466 |
| `overtrain_sweep_dare_ties_e3` | B | 3-expert probe · DARE-TIES · uniform @ e3 | 0.575 | **0.460** |  | **0.431** | 0.483 | 0.409 | 0.477 | 0.477 | 0.476 | 0.460 | 0.460 | 0.489 | — | 0.373 | 0.420 | 0.367 | 0.489 | 0.455 | 0.483 |
| `overtrain_sweep_dare_ties_e6` | B | 3-expert probe · DARE-TIES · uniform @ e6 | 0.674 | **0.467** |  | **0.435** | 0.466 | 0.426 | 0.483 | 0.489 | 0.441 | 0.494 | 0.466 | 0.506 | — | 0.373 | 0.400 | 0.407 | 0.494 | 0.443 | 0.494 |
| `overtrain_sweep_dare_ties_e9` | B | 3-expert probe · DARE-TIES · uniform @ e9 | 0.680 | **0.469** |  | **0.442** | 0.472 | 0.432 | 0.489 | 0.494 | 0.434 | 0.494 | 0.460 | 0.489 | — | 0.380 | 0.407 | 0.420 | 0.494 | 0.466 | 0.483 |
| **Individual over-trained experts (§5.3)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `ot_L1b_e1` | B | r32 · s17 · L1b · @ e1 | 0.295 | **0.425** |  | **0.397** | 0.455 | 0.409 | 0.420 | 0.438 | 0.421 | 0.438 | 0.455 | 0.455 | — | 0.353 | 0.407 | 0.367 | 0.398 | 0.415 | 0.443 |
| `ot_L1b_e3` | B | r32 · s17 · L1b · @ e3 | 0.526 | **0.459** |  | **0.423** | 0.466 | 0.466 | 0.506 | 0.483 | 0.441 | 0.398 | 0.460 | 0.443 | — | 0.340 | 0.427 | 0.393 | 0.477 | 0.449 | 0.449 |
| `ot_L1b_e6` | B | r32 · s17 · L1b · @ e6 | 0.622 | **0.451** |  | **0.436** | 0.472 | 0.466 | 0.500 | 0.489 | 0.372 | 0.426 | 0.438 | 0.460 | — | 0.427 | 0.440 | 0.420 | 0.455 | 0.443 | 0.432 |
| `ot_L1b_e9` | B | r32 · s17 · L1b · @ e9 | 0.629 | **0.462** |  | **0.432** | 0.489 | 0.466 | 0.489 | 0.517 | 0.400 | 0.438 | 0.432 | 0.466 | — | 0.393 | 0.413 | 0.407 | 0.489 | 0.460 | 0.432 |
| `ot_S1_e1` | B | r32 · s17 · S1 · @ e1 | 0.262 | **0.388** |  | **0.388** | 0.438 | 0.318 | 0.409 | 0.420 | 0.393 | 0.398 | 0.403 | 0.432 | — | 0.400 | 0.353 | 0.327 | 0.438 | 0.398 | 0.409 |
| `ot_S1_e3` | B | r32 · s17 · S1 · @ e3 | 0.458 | **0.398** |  | **0.373** | 0.438 | 0.352 | 0.403 | 0.420 | 0.421 | 0.392 | 0.432 | 0.426 | — | 0.380 | 0.413 | 0.313 | 0.398 | 0.341 | 0.392 |
| `ot_S1_e6` | B | r32 · s17 · S1 · @ e6 | 0.541 | **0.421** |  | **0.401** | 0.443 | 0.386 | 0.392 | 0.449 | 0.428 | 0.449 | 0.443 | 0.477 | — | 0.427 | 0.380 | 0.327 | 0.449 | 0.358 | 0.466 |
| `ot_S1_e9` | B | r32 · s17 · S1 · @ e9 | 0.547 | **0.413** |  | **0.383** | 0.426 | 0.369 | 0.381 | 0.432 | 0.441 | 0.443 | 0.415 | 0.483 | — | 0.380 | 0.387 | 0.327 | 0.432 | 0.330 | 0.443 |
| `ot_S2_e1` | B | r32 · s17 · S2 · @ e1 | 0.300 | **0.435** |  | **0.382** | 0.443 | 0.375 | 0.460 | 0.438 | 0.462 | 0.438 | 0.455 | 0.460 | — | 0.320 | 0.373 | 0.313 | 0.438 | 0.409 | 0.438 |
| `ot_S2_e3` | B | r32 · s17 · S2 · @ e3 | 0.528 | **0.460** |  | **0.417** | 0.483 | 0.398 | 0.477 | 0.494 | 0.441 | 0.489 | 0.477 | 0.494 | — | 0.393 | 0.367 | 0.333 | 0.500 | 0.455 | 0.455 |
| `ot_S2_e6` | B | r32 · s17 · S2 · @ e6 | 0.622 | **0.446** |  | **0.409** | 0.477 | 0.386 | 0.483 | 0.483 | 0.421 | 0.455 | 0.477 | 0.489 | — | 0.347 | 0.373 | 0.360 | 0.466 | 0.443 | 0.466 |
| `ot_S2_e9` | B | r32 · s17 · S2 · @ e9 | 0.629 | **0.458** |  | **0.412** | 0.477 | 0.398 | 0.494 | 0.489 | 0.448 | 0.460 | 0.483 | 0.477 | — | 0.360 | 0.380 | 0.373 | 0.466 | 0.415 | 0.477 |
| **Merge-optimal search — every round's candidates (§5.2)** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| `mo_r1_L0_e1_ae1a2d64` | B | merge-optimal round 1 · L0 @ e1 | 0.272 | **0.428** |  | **0.427** | 0.489 | 0.386 | 0.438 | 0.460 | 0.428 | 0.426 | 0.460 | 0.472 | — | 0.413 | 0.433 | 0.400 | 0.449 | 0.426 | 0.443 |
| `mo_r1_L0_e2_062a66bb` | B | merge-optimal round 1 · L0 @ e2 | 0.280 | **0.429** |  | **0.424** | 0.483 | 0.381 | 0.432 | 0.477 | 0.421 | 0.432 | 0.466 | 0.472 | — | 0.407 | 0.420 | 0.407 | 0.438 | 0.432 | 0.443 |
| `mo_r1_L0_e3_d6c84724` | B | merge-optimal round 1 · L0 @ e3 | 0.285 | **0.429** |  | **0.426** | 0.477 | 0.381 | 0.426 | 0.472 | 0.434 | 0.432 | 0.466 | 0.477 | — | 0.413 | 0.427 | 0.393 | 0.449 | 0.426 | 0.449 |
| `mo_r1_L0_e4_275dd9db` | B | merge-optimal round 1 · L0 @ e4 | 0.288 | **0.428** |  | **0.422** | 0.483 | 0.375 | 0.432 | 0.477 | 0.428 | 0.426 | 0.455 | 0.477 | — | 0.413 | 0.427 | 0.393 | 0.432 | 0.426 | 0.443 |
| `mo_r1_L0_e5_93c15bdc` | B | merge-optimal round 1 · L0 @ e5 | 0.290 | **0.429** |  | **0.422** | 0.477 | 0.381 | 0.426 | 0.477 | 0.428 | 0.432 | 0.466 | 0.472 | — | 0.420 | 0.413 | 0.393 | 0.443 | 0.420 | 0.443 |
| `mo_r1_L0_e6_7db432a5` | B | merge-optimal round 1 · L0 @ e6 | 0.290 | **0.429** |  | **0.420** | 0.472 | 0.381 | 0.432 | 0.466 | 0.434 | 0.432 | 0.460 | 0.477 | — | 0.413 | 0.413 | 0.400 | 0.438 | 0.409 | 0.449 |
| `mo_r1_L0_e7_05d4a760` | B | merge-optimal round 1 · L0 @ e7 | 0.291 | **0.428** |  | **0.418** | 0.477 | 0.386 | 0.432 | 0.466 | 0.428 | 0.426 | 0.466 | 0.466 | — | 0.413 | 0.413 | 0.387 | 0.432 | 0.415 | 0.449 |
| `mo_r1_L0_e8_a70f0773` | B | merge-optimal round 1 · L0 @ e8 | 0.291 | **0.431** |  | **0.423** | 0.483 | 0.381 | 0.420 | 0.483 | 0.441 | 0.432 | 0.466 | 0.472 | — | 0.420 | 0.413 | 0.393 | 0.443 | 0.426 | 0.443 |
| `mo_r1_L0_e9_bd8a806c` | B | merge-optimal round 1 · L0 @ e9 | 0.291 | **0.431** |  | **0.419** | 0.477 | 0.381 | 0.432 | 0.477 | 0.434 | 0.432 | 0.460 | 0.466 | — | 0.420 | 0.413 | 0.400 | 0.426 | 0.420 | 0.432 |
| `mo_r2_L1b_e1_e0656264` | B | merge-optimal round 2 · L1b @ e1 | 0.272 | **0.430** |  | **0.426** | 0.472 | 0.369 | 0.438 | 0.477 | 0.434 | 0.432 | 0.455 | 0.472 | — | 0.413 | 0.420 | 0.393 | 0.455 | 0.426 | 0.449 |
| `mo_r2_L1b_e2_ae58e683` | B | merge-optimal round 2 · L1b @ e2 | 0.280 | **0.430** |  | **0.427** | 0.483 | 0.375 | 0.438 | 0.466 | 0.434 | 0.438 | 0.466 | 0.466 | — | 0.420 | 0.427 | 0.393 | 0.449 | 0.426 | 0.449 |
| `mo_r2_L1b_e3_9e8b75f6` | B | merge-optimal round 2 · L1b @ e3 | 0.285 | **0.429** |  | **0.427** | 0.483 | 0.381 | 0.432 | 0.472 | 0.428 | 0.432 | 0.466 | 0.472 | — | 0.413 | 0.433 | 0.393 | 0.455 | 0.426 | 0.443 |
| `mo_r2_L1b_e4_126c69e4` | B | merge-optimal round 2 · L1b @ e4 | 0.288 | **0.430** |  | **0.424** | 0.466 | 0.375 | 0.438 | 0.477 | 0.428 | 0.432 | 0.466 | 0.472 | — | 0.420 | 0.427 | 0.393 | 0.438 | 0.426 | 0.438 |
| `mo_r2_L1b_e5_7e95cee8` | B | merge-optimal round 2 · L1b @ e5 | 0.290 | **0.431** |  | **0.420** | 0.483 | 0.381 | 0.438 | 0.477 | 0.428 | 0.432 | 0.466 | 0.472 | — | 0.413 | 0.420 | 0.400 | 0.426 | 0.420 | 0.443 |
| `mo_r2_L1b_e6_351cbd10` | B | merge-optimal round 2 · L1b @ e6 | 0.290 | **0.430** |  | **0.420** | 0.489 | 0.386 | 0.438 | 0.466 | 0.434 | 0.426 | 0.466 | 0.472 | — | 0.413 | 0.413 | 0.393 | 0.443 | 0.420 | 0.438 |
| `mo_r2_L1b_e7_4b624330` | B | merge-optimal round 2 · L1b @ e7 | 0.291 | **0.436** |  | **0.418** | 0.477 | 0.392 | 0.438 | 0.477 | 0.434 | 0.438 | 0.466 | 0.466 | — | 0.413 | 0.413 | 0.400 | 0.426 | 0.415 | 0.443 |
| `mo_r2_L1b_e8_70780f97` | B | merge-optimal round 2 · L1b @ e8 | 0.291 | **0.432** |  | **0.423** | 0.477 | 0.386 | 0.426 | 0.483 | 0.434 | 0.432 | 0.466 | 0.477 | — | 0.413 | 0.413 | 0.400 | 0.438 | 0.432 | 0.443 |
| `mo_r2_L1b_e9_a70f0773` | B | merge-optimal round 2 · L1b @ e9 | 0.291 | **0.431** |  | **0.421** | 0.472 | 0.381 | 0.426 | 0.477 | 0.434 | 0.438 | 0.466 | 0.472 | — | 0.413 | 0.413 | 0.400 | 0.443 | 0.415 | 0.443 |
| `mo_r3_L1r_e1_63242db2` | B | merge-optimal round 3 · L1r @ e1 | 0.272 | **0.430** |  | **0.424** | 0.483 | 0.392 | 0.420 | 0.477 | 0.428 | 0.432 | 0.466 | 0.455 | — | 0.413 | 0.427 | 0.393 | 0.443 | 0.426 | 0.443 |
| `mo_r3_L1r_e2_e0652d4c` | B | merge-optimal round 3 · L1r @ e2 | 0.279 | **0.430** |  | **0.428** | 0.472 | 0.381 | 0.432 | 0.483 | 0.428 | 0.426 | 0.466 | 0.472 | — | 0.413 | 0.427 | 0.393 | 0.455 | 0.438 | 0.443 |
| `mo_r3_L1r_e3_b398408b` | B | merge-optimal round 3 · L1r @ e3 | 0.285 | **0.436** |  | **0.424** | 0.477 | 0.386 | 0.443 | 0.483 | 0.434 | 0.432 | 0.466 | 0.483 | — | 0.413 | 0.420 | 0.393 | 0.443 | 0.432 | 0.443 |
| `mo_r3_L1r_e4_7118282b` | B | merge-optimal round 3 · L1r @ e4 | 0.288 | **0.429** |  | **0.424** | 0.477 | 0.381 | 0.432 | 0.472 | 0.434 | 0.426 | 0.460 | 0.483 | — | 0.413 | 0.420 | 0.393 | 0.438 | 0.432 | 0.449 |
| `mo_r3_L1r_e5_390562f2` | B | merge-optimal round 3 · L1r @ e5 | 0.289 | **0.430** |  | **0.419** | 0.477 | 0.386 | 0.426 | 0.472 | 0.434 | 0.432 | 0.466 | 0.472 | — | 0.413 | 0.413 | 0.387 | 0.432 | 0.426 | 0.443 |
| `mo_r3_L1r_e6_ac4dd90b` | B | merge-optimal round 3 · L1r @ e6 | 0.290 | **0.428** |  | **0.423** | 0.483 | 0.375 | 0.432 | 0.477 | 0.428 | 0.426 | 0.460 | 0.477 | — | 0.413 | 0.420 | 0.407 | 0.438 | 0.420 | 0.438 |
| `mo_r3_L1r_e7_d137d7e6` | B | merge-optimal round 3 · L1r @ e7 | 0.290 | **0.431** |  | **0.418** | 0.489 | 0.386 | 0.432 | 0.472 | 0.434 | 0.432 | 0.466 | 0.472 | — | 0.413 | 0.413 | 0.400 | 0.426 | 0.415 | 0.443 |
| `mo_r3_L1r_e8_15c7bd7d` | B | merge-optimal round 3 · L1r @ e8 | 0.291 | **0.430** |  | **0.421** | 0.483 | 0.381 | 0.432 | 0.472 | 0.434 | 0.432 | 0.466 | 0.477 | — | 0.413 | 0.427 | 0.393 | 0.432 | 0.415 | 0.443 |
| `mo_r3_L1r_e9_4b624330` | B | merge-optimal round 3 · L1r @ e9 | 0.291 | **0.432** |  | **0.419** | 0.483 | 0.386 | 0.426 | 0.483 | 0.434 | 0.432 | 0.466 | 0.466 | — | 0.420 | 0.413 | 0.387 | 0.438 | 0.415 | 0.443 |


#### 2.2.1 One best row per family — the table at a glance

*Added 2026-09-08.* The table above is 169 rows; this is one row from each of its sections, so the
families can be compared without scrolling. **Selection rule: the highest `mean single` within the
family.** Read it with three things in mind.

1. **The two grids are separated on purpose and must stay that way.** Grid B numbers are measured on
   33–40 ICSE programs against Grid A's 317–557, and the two program sets are disjoint (§2), so a
   Grid B row is not "better" than a Grid A row — it is a different measurement. Compare within a
   block, never across.
2. **Only the `mean single` column is the winner's own claim to the row.** The `unseen (H1)` and
   `mean composed` values are whatever *that* row happened to score; they are **not** the family's
   best on those columns. A family can top `mean single` and be mid-table on `H1`.
3. **`—` means the winning row was never run on that group**, not that it scored zero.

**And the point of splitting the means shows up immediately.** On Grid B the `mean single` ranking is
led by `mole_router` at 0.496 — but on the column that actually discriminates, `unseen (H1)`, the
clean-code control `tuned_L0` is top at **0.400**, ahead of every merge, router and mixture in the
block. On Grid A the whole spread of family winners is **0.378 to 0.396**, under two points, with the
clean-code control inside it. That is the project's central result visible in one screen: **the
ladder is where the arms differ, and they barely differ; the unseen column is where they separate,
and there the control wins.**

**Grid A — 317–557 corpus programs** — the grid every RQ1/RQ2 headline is computed on.

| family | best row | settings | mean single | unseen (H1) | mean composed |
|---|---|---|---:|---:|---:|
| Monolithic breadth / capacity | `mono_r64` | r64 · s17 · all 6 | **0.396** | **0.239** | **0.366** |
| Per-condition specialists | `tuned_S2_s17` | r32 · s17 · S2 | **0.394** | **0.280** | **0.343** |
| Attempted repairs | `composite_ablation` | r32 · s17 · same 6 mechanisms **unstacked** | **0.393** | **0.237** | — |
| Leave-one-transform-out | `loto_holdL0` | r32 · s17 · 5 of 6, **holding out L0** | **0.390** | — | — |
| Reference (untuned / clean-code control) | `tuned_L0_s17` | r32 · s17 · L0 | **0.378** | **0.247** | **0.313** |
| Zero-training (prompting, normalization) | `icl_k4_cross` | 0 train · k=4 demos · cross | **0.274** | **0.182** | — |

**Grid B — 33–40 ICSE test-set programs** — small, and where most of the merge/router work happened.

| family | best row | settings | mean single | unseen (H1) | mean composed |
|---|---|---|---:|---:|---:|
| RouterLoRA ladder | `mole_router` | 8 experts · trained gate | **0.496** | **0.339** | **0.454** |
| Per-condition specialists | `tuned_L2` | r32 · s17 · L2 | **0.471** | — | **0.428** |
| 3-expert overtrain sweep | `overtrain_sweep_dare_ties_e9` | 3-expert probe · DARE-TIES · uniform @ e9 | **0.469** | — | **0.442** |
| Routing + six-specialist merges | `router` | 6 experts · classifier dispatch | **0.468** | — | — |
| Merge density sweep / residual merges | `sweep_dare_ties_d0p3` | 6 experts · DARE-TIES · d0.3 — density sweep | **0.468** | **0.322** | — |
| Individual over-trained experts | `ot_L1b_e9` | r32 · s17 · L1b · @ e9 | **0.462** | — | **0.432** |
| Uniform-epoch merges (8 experts) | `overtrain_full_dare_ties_e9` | 8-expert bank · DARE-TIES · uniform @ e9 | **0.460** | — | **0.435** |
| ICL / shot count | `tuned_L0_k0` | r32 · s17 · L0 · k=0 demos | **0.451** | **0.339** | **0.415** |
| Reference (untuned / clean-code control) | `tuned_L0` | r32 · s17 · L0 | **0.450** | **0.400** | — |
| Merge-optimal search | `mo_r2_L1b_e7_4b624330` | merge-optimal round 2 · L1b @ e7 | **0.436** | — | **0.418** |
| Merge controls | `l0merge_dare_ties` | **3× clean-code adapters** s17/42/101 · DARE-TIES · d0.5 | **0.407** | **0.339** | — |
| Zero-training (prompting, normalization) | `icl_k1_cross` | 0 train · k=1 demos · cross | **0.288** | **0.217** | **0.252** |
...
### 2.2b Every system, every condition — the CodeLlama / Llama panel

*Added 2026-09-08.* §2.2 does this for the frozen Qwen panel and is **Qwen-only by the rule stated in
its own preamble**: 7B roughly doubles accuracy on every condition, so one 7B row in a 1.5B table
would be a model effect wearing a system's name. That rule is right, which is why this is a separate
table rather than more rows in that one — and why the models below are **blocked, never interleaved**.
Do not difference a row in one block against a row in another.

Generated by [`scripts/analysis/49_master_panel_table.py`](scripts/analysis/49_master_panel_table.py)
→ `results/analysis/master_panel_table.md`, recomputed from the per-cell parquets; the `settings`
column is derived from each cell's own `adapter_id`, not hand-written. **116 systems** across five
model × language blocks, of which **96 are CodeLlama-7b Python** — the live panel, which until now
had no whole-panel table anywhere in this document (§26 ranks 83 of them per condition, but a
leaderboard is not a matrix).

**`X1`, not `H1`, is the held-out column that gets a summary slot.** H1's budget is spent (§27.1), so
its 14 cells are frozen historical reads; X1 is the live discriminator with 36. Both are shown. **No
H1 stimulus is read here** — re-tabulating a number a logged read already produced spends no
quarantine budget (CLAUDE.md §3.2 rule 3 counts reads of `data/quarantine/`).

**Three filters run before any cell is selected, and the first draft of the generator got this
wrong in a way worth recording.** Selection was "largest n, then newest", which silently picked
`inverse_generic` for `tuned_L0` on `L0` — the **input-prediction** task (§29.4), a different task
whose cell happens to carry one more row (1,671 against 1,670). `tuned_L0` on `L0` came out as
**0.324** instead of **0.428**. The filters now are: no inverse prompts (the task is identified by
the `prompt_id`, not the phase — oracle and ICL prompts stay in, being different *prompting* of the
same forward task); no `selfcons_generic`, which samples at T = 0.7 and which §26 excludes for the
same reason; no `*_testset` phases, which are a different grid; and `mole_generic` only for `mole_*`
systems, matching §2.2's engine rule. **That change took the count of cells disagreeing by more than
0.5 points across phases from 253 to 3.**

`n_prog` is the program count behind the five single-transform columns — the basis of `mean single`.
It is shown because a mean over a different program set is the other way tables like this mislead
(RQ_SUMMARY §4.1, corrected the same day). It reads `416–557` for most rows because **`S1` bails on
some programs by design** (CLAUDE.md §4, "correctness beats coverage"). The `X1`, `H1` and composite
cells sit on their own, usually smaller, program sets — which is exactly why they are separate
columns rather than folded into one number.
